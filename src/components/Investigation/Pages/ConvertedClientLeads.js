...
function ConvertedClientLeads() {
    ...
    return (
        <div>
            <Verticlechart Data={Leads} Comment={`Convetred Client Leads ${moment(firstDay).format('MMMM')}`}/>
        </div>
    );
}

export default ConvertedClientLeads;
