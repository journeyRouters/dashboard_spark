...
function Paymentawaited() {
    const [PaymentsAwaited, setPaymentsAwaited] = useState([])
    ...
    function getAllUserProfiles() {
        ...
        return onSnapshot(q, (querySnapshot) => {
            querySnapshot.forEach((doc) => {
                ...
                getConvertedDataForUserProfile(usersProfile, DataQuery, setPaymentsAwaited);
            });
        });
    }
    useEffect(() => {
    ...
    return (
        <div>
            <Verticlechart Data={PaymentsAwaited} Comment={'Payment Awaited'}/>
        </div>
    );
}

export default Paymentawaited;
