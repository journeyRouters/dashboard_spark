...
//             // Optionally, you could set the socket state to null or handle reconnection here
//         };

//         ws.onerror = (error) => {
//             console.error('WebSocket error:', error); // Capture errors
//         };
...
//                     <li key={index}>{lead.name} - {lead.contact}</li> // Replace with your lead properties
//                 ))}
//             </ul>
//         </div>
//     );
