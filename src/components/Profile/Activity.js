export const avtivityList = {
    ...
    Kerala: [
        ...
        },
        {
            ...
            value: "BackwaterAlleppey",
        },
        {
            label: "Cheeyappara Waterfalls",
            value: "CheeyapparaWaterfalls",
        },
        {
            label: "Eravikulam National Park",
            value: "EravikulamNationalPark",
        },
        {
            label: "Jeep Safari Thekkady",
            value: "JeepSafariThekkady",
        },
        {
            label: "Jewish Synagogue",
            value: "JewishSynagogue",
        },
        {
            label: "Kuthiramalika Palace Trivandrum",
            value: "KuthiramalikaPalaceTrivandrum",
        },
        {
            label: "Mattancherry Palace",
            value: "MattancherryPalace",
        },
        {
        ...
        {
            label: "Periyar Wildlife Sanctuary",
            value: "PeriyarWildlifeSanctuary",
        },
        {
            label: "Sucheendran Temple",
            value: "SucheendranTemple",
        },
        {
        ...
        {
            label: "The Zoological Park",
            value: "TheZoologicalPark",
        },
        {
            label: "Vattakottai",
            value: "Vattakottai",
        ...
        {
            label: "Vivekananda Rock",
            value: "VivekanandaRock",
        },
        {
            label: "Arrival",
            value: "Arrival",
